...
import 'dart:convert';
import 'base.dart';
typedef WebCallback = void Function(dynamic data);
class WebviewScaffold extends StatefulWidget {
    ...
    callback 
        ...
        .map<String>(
            (element)=>element
              ...
              if(webCallback!=null)
                webCallback(json.decode(onData));
                var x=0;
            });
  }
  final WebCallback webCallback;
  final EventChannel callback=EventChannel('ponnamkarthik/flutterwebview_stream_callback');
  ...
  // Stream<String> get onPageCallback {
  //   var url = callback
  //       .receiveBroadcastStream()
  //       .map<String>(
  //           (element){
